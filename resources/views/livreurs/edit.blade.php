        ...
        <!-- main -->
            <main class="main-content-wrapper">
                ...
                <div class="container">
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Modifier un livreur</li>
                                        </ol>
                                    </nav>
                                </div>
                                <div>
                    ...
                    <form action="{{ url('livreurs/'.$livreur->id.'/update') }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
                                    ...
                                    <div class="card-body p-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-lg-6">
                                                ...
                                                <input type="text" name="nom" value="{{$livreur->nom}}"  class="form-control" placeholder="Nom du livreur"
                                                       required/>
                                            </div>
                                            <!-- input -->
                                            <div class="mb-3 col-lg-6">
                                                <label class="form-label">Prénoms</label>
                                                <input type="text" name="prenoms" value="{{$livreur->prenoms}}" class="form-control" placeholder="Prénoms du livreur" required/>
                                            </div>
                                            <div class="mb-3 col-lg-6">
                                                <label class="form-label">Adresse</label>
                                                <input type="text" name="adresse" value="{{$livreur->adresseResidence}}" class="form-control" placeholder="Adresse" required/>
                                            </div>
                                            <div class="mb-3 col-lg-6">
                                                <label class="form-label">Téléphone</label>
                                                <input type="number" name="phone" value="{{$livreur->phoneNumber}}" class="form-control" placeholder="Téléphone" required/>
                                            </div>
