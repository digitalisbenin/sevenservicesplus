                                        ...
                                        <table
                                            ...
                                            @foreach($paiement as $value)
                                                <tr>
                                                    ...
                                                    {{--  <td><a href="#" class="">{{$value->commande->numeroCommande}} </a></td>  --}}
                                                    <td><a href="#" class="text-reset">{{ $value->montantPaye }} FCFA</a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        {{ $value->commande->users->nom }}  {{ $value->commande->users->prenoms }} 
