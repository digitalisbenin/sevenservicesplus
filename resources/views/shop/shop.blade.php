                        ...
                        <div class="offcanvas offcanvas-start offcanvas-collapse w-md-50" tabindex="-1"
                            ...
                            <div class="offcanvas-body ps-lg-2 pt-lg-0">
                                ...
                                <div class="mb-8 position-relative">
                                    ...
                                    <!-- Banner Image -->
                                    <!-- img -->
                                    <img src="{{ asset('assets/images/banner/assortment-citrus-fruits.png') }}" alt=""
                            ...
                            <div class="d-md-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <a href="shop-grid-3-column.html" class="me-3 active"><i
                                ...
                                <div class="card card-product">
                                    <div class="card-body">
                                        <div class="text-center position-relative">
                                            ...
                                            <a href="shop-single.html">
                                                <!-- img -->
                                                <img src="{{asset('assets/images/products/product-img-4.jpg')}}"
                                                     alt="Grocery Ecommerce Template" class="mb-3 img-fluid"/>
                                            </a>
                                            <!-- action btn -->
                                            <div class="card-product-action">
                                ...
                                <div class="card card-product">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center position-relative">
                                            ...
                                            <a href="shop-single.html">
                                                <!-- img -->
                                                <img src="{{ asset('assets/images/products/product-img-6.jpg') }}"
                                                     alt="Grocery Ecommerce Template" class="mb-3 img-fluid"/>
                                            </a>
                                            <!-- action btn -->
                                            <div class="card-product-action">
                            ...
                            <div class="col">
                                ...
                                <div class="card card-product">
                                    <div class="card-body">
                                        ...
                                        <h2 class="fs-6"><a href="shop-single.html"
                                                            class="text-inherit text-decoration-none">Amul Butter - 500
                                                g</a></h2>
                                        <div class="text-warning">
                                            <!-- rating -->
                                            <small>
