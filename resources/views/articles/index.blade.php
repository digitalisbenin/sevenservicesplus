                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="-item"><a href="{{ url('articles') }}"
                                                                           class="text-inherit">Parcelle</a></li>/
                                            <li class="-item active" aria-current="page">Modifier une parcelle
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="card mb-6 card-lg">
                                    ...
                                    <div class="card-body p-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <!-- input -->
                                            <div class="mb-3 col-lg-6">
                                                <label class="form-label">Site du parcelle</label>
                                                <select class="form-select"
                                                        name="site_id" {{--id="categorie_id"--}}>
                                                    <option selected>Selectionner du parcelle</option>


                                                    @foreach($categorie as $value)
                                                        <option
                                                            value="{{ $value->id }}"@if($value->id == $article->site_id) selected @endif>{{ $value ->name }}</option>
                                                    @endforeach
                                            ...
                                            <div>
                                                <div class="mb-3 col-lg-12 mt-5">
                                                    ...
                                                    <div class="mb-4 d-flex">
                                                        ...
                                                        @if($article->image)
                                                        <img src="{{ asset('assets/uploads/articles_images/'.$article->image) }}" class="w-20 ml-5" alt="Image du parcelle">
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- input -->
                                            <div class="mb-3 col-lg-12 mt-5">
                                                <h4 class="mb-3 h5">Description du parcelle</h4>
                                                <div class="form-floating">
                                                <textarea class="form-control"
                                                          name="details" style="height: 130px"> {{$article->details}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-12">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="vedette"
                                                           id="inlineRadio1" value="1" {{ $article->vedette === 1 ? 'checked' : '' }} />
                                                    <label class="form-check-label" for="inlineRadio1">Vedette</label>
                                                </div>
                                                <!-- input -->
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="vedette"
                                                           id="inlineRadio2" value="0"{{ $article->vedette === 0 ? 'checked' : '' }} />
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="disponible"
                                                           id="inlineRadio1" value="1" {{ $article->disponible === 1 ? 'checked' : '' }} />
                                                    <label class="form-check-label" for="inlineRadio1">Disponible</label>
                                                </div>
                                                <!-- input -->
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="disponible"
                                                           id="inlineRadio2" value="0"{{ $article->disponible === 0 ? 'checked' : '' }} />
                                ...
                                <div class="card mb-6 card-lg">
                                    <!-- card body -->
                                    <div class="card-body p-6">
                                        <h4 class="mb-4 h5">Superficie</h4>
                                        <div class="mb-3">
                                            <label class="form-label">Superficie</label>
                                            <input type="text" name="area" value="{{$article->area}}"  class="form-control"
                                                   placeholder="0.00 m²"/>
                                        </div>
                                        <h4 class="mb-4 h5">Prix du parcelle</h4>
                                        <!-- input -->
                                        <div class="mb-3">
                                            <label class="form-label">Prix standard</label>
                                            <input type="text" name="normal_price" value="{{$article->normal_price}}"  class="form-control"
                                                   placeholder="0.00 FCFA"/>
                                        </div>
                                        <!-- input -->
                                        <div class="mb-3">
                                            <label class="form-label">Prix promotion</label>
                                            <input type="text" name="promo_price" value="{{$article->promo_price}}" class="form-control"
                                                   placeholder="0.00 FCFA"/>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- button -->
                                <div class="d-grid">
                                    <button class="btn btn-primary" type="submit">Modifier une parcelle</button>
                                </div>
                            </div>
                        </div>
                    </form>
