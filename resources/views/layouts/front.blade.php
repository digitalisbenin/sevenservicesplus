...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon"
          href="{{ asset('assets/images/7services.ico') }}">
            ...
            <div class="row gy-4 align-items-center">
                <div class="col-md-12 text-center">
					<span class="text-lg text-white text-center">
						...
						SEVEN SERVICES PLUS IMMOBILIERS.Tous droit réservées. Designer Par
						<a href="https://digitalis.wadounnou.com/">Digitalis</a>
					</span>
                </div>
